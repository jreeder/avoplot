...
class PlotPanelBase(wx.ScrolledWindow):
    ...
    def __init__(self, parent):
        ...
        sizer.Add(self.tb,0,wx.ALIGN_TOP|wx.EXPAND)
        sizer.Add(self.canvas, 1, wx.ALIGN_LEFT|wx.ALIGN_TOP|wx.EXPAND)
    ...
    def _create_plot(self):
        raise NotImplementedError("PlotPanelBase must be subclassed")
...
class SpectrumPlot(PlotPanelBase):
    ...
    def _create_plot(self):
        wx.CallAfter(self.axes.plot,self.spectrum.wavelengths, self.spectrum.counts)
